...
from yr_enum import IntEnum, IntFlag
...
class RegexpOpcode(IntEnum):
    ...
    RE_OPCODE_REPEAT_ANY_GREEDY   = 0xB4
    RE_OPCODE_REPEAT_ANY_UNGREEDY = 0xB5

    RE_OPCODE_SPLIT_A             = 0xC0
    RE_OPCODE_SPLIT_B             = 0xC1
    RE_OPCODE_JUMP                = 0xC2
    RE_OPCODE_REPEAT_START_GREEDY = 0xC3
    RE_OPCODE_REPEAT_END_GREEDY   = 0xC4
    RE_OPCODE_REPEAT_START_UNGREEDY= 0xC5
    RE_OPCODE_REPEAT_END_UNGREEDY = 0xC6
